...
function showQuestion() {
    ...
    const qCountEI= document.getElementById("question-counter");
    qCountEI.textContent =`Question ${currentIndex + 1} of ${questions.length}`;
...
// const btnStart = document.getElementById("start-btn").addEventListener("click", startQuiz);
